	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				target:   3,
				taken:    *mustPai("E"),
				consumed: [2]base.Pai{*mustPai("S"), *mustPai("W")},
			},
			want:    nil,
			wantErr: true,
		},
		{
			...
			args: args{
				...
				target:   3,
				taken:    *mustPai("6s"),
				consumed: [2]base.Pai{*mustPai("5p"), *mustPai("7p")},
			},
			want:    nil,
			wantErr: true,
		},
		{
			...
			args: args{
				...
				target:   3,
				taken:    *mustPai("6p"),
				consumed: [2]base.Pai{*mustPai("5p"), *mustPai("7s")},
			},
			want:    nil,
			wantErr: true,
		},
		{
			...
			args: args{
				...
				target:   3,
				taken:    *mustPai("6p"),
				consumed: [2]base.Pai{*mustPai("5p"), *mustPai("8p")},
			},
			want:    nil,
			wantErr: true,
		},
