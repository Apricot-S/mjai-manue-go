...
func TestHas1Han(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			melds:         nil,
			winningTile:   new(tile.MustTileFromCode("2p")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			melds:         nil,
			winningTile:   new(tile.MustTileFromCode("C")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			melds:         nil,
			winningTile:   new(tile.MustTileFromCode("9s")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			melds:         nil,
			winningTile:   new(tile.MustTileFromCode("8s")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			melds:         nil,
			winningTile:   new(tile.MustTileFromCode("1m")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			melds:         nil,
			winningTile:   new(tile.MustTileFromCode("3m")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			winningTile:   new(tile.MustTileFromCode("1p")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			winningTile:   new(tile.MustTileFromCode("N")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			melds:         nil,
			winningTile:   new(tile.MustTileFromCode("7p")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			melds:         nil,
			winningTile:   new(tile.MustTileFromCode("6p")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
		...
		},
		{
			...
			winningTile:   new(tile.MustTileFromCode("3p")),
			prevalentWind: wind.East,
			seatWind:      wind.South,
			tsumo:         false,
			riichi:        false,
