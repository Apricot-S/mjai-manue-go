	...
	tests := []testCase{
		{
			...
			wantMsg:  &Action{Message: Message{Type: "action"}, Actor: 0},
		...
		},
		{
			...
			wantMsg:  &Action{Message: Message{Type: "action"}, Actor: 3},
		...
		},
		{
			...
			wantMsg:  &Action{Message: Message{Type: "action"}, Actor: -1},
		...
		},
		{
			...
			wantMsg:  &Action{Message: Message{Type: "action"}, Actor: 4},
		...
		},
		{
			...
			input:    `{"type":"action"}`,
			wantMsg:  &Action{Message: Message{Type: "action"}},
			wantJSON: `{"type":"action","actor":0}`,
			wantErr:  false,
		},
		{
...
func TestAction_Validate(t *testing.T) {
	...
	tests := []testCase{
		{
			name:    "min_actor",
			msg:     &Action{Message: Message{Type: "action"}, Actor: 0},
			wantErr: false,
		},
		{
			name:    "max_actor",
			msg:     &Action{Message: Message{Type: "action"}, Actor: 3},
			wantErr: false,
		},
		{
			name:    "actor_out_of_range_lower",
			msg:     &Action{Message: Message{Type: "action"}, Actor: -1},
			wantErr: true,
		},
		{
			name:    "actor_out_of_range_upper",
			msg:     &Action{Message: Message{Type: "action"}, Actor: 4},
			wantErr: true,
		},
	}
